...
function receivedMessage(event) {
  ...
  var ref = db.ref("facebook-messager/"+senderID);
  ref.push({
    "sender_id": senderID,
    "time": timeOfMessage,
    "message": messageText,
  ...
  if (messageText) {
    ...
    switch (messageText) {
      ...
      default:
        sendTextMessage(senderID, "We are currently logging all messages to our system. We will get back to you in a timely manner. Thank you for your patience.");
    }
